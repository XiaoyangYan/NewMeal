        ...
        render(){
                return(
                        ...
                        <div className="bookmark-btn">
                                <Link to={{pathname:`/card/${this.props.title}`, state:{label:`${this.props.title}`, name:`${this.props.name}`}}} exact="true" className="add-bookmark block inp-btn btn-white"><span>Save</span></Link>
                        </div>
                        <div className="box">
